...
<head>
    ...
    <title>Edit Product - Vending System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Update product details in inventory</p>
        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" 
                               ...
                               value="<?= htmlspecialchars($formData['name'] ?? $product['name'] ?? '') ?>" 
                               required
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="<?= htmlspecialchars($formData['price'] ?? $product['price'] ?? '') ?>" 
                               required
                               placeholder="0.00">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="<?= htmlspecialchars($formData['quantity_available'] ?? $product['quantity_available'] ?? '') ?>" 
                               required
